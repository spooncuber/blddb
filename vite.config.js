  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "bigbld/tcenter": resolve(__dirname, "bigbld/tcenter.html"),
        "bigbld/wing": resolve(__dirname, "bigbld/wing.html"),
        "bigbld/xcenter": resolve(__dirname, "bigbld/xcenter.html"),
        ...
        "nightmare": resolve(__dirname, "nightmare.html"),
